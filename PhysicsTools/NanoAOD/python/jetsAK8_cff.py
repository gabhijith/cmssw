...
fatJetTable = simpleCandidateFlatTableProducer.clone(
	...
	globalParT_TopbWmv = Var("bDiscriminator('pfParticleTransformerAK8MDJetTags:probTopbWmv')",float,doc="Global ParT Top->bWmv score",precision=10),
        ...
        globalParT_Xbbbb = Var("bDiscriminator('pfParticleTransformerAK8MDJetTags:probHZZbbbb')+bDiscriminator('pfParticleTransformerAK8MDJetTags:probHZxZxbbbb')+bDiscriminator('pfParticleTransformerAK8MDJetTags:probHZxZxStarbbbb')",float,doc="Global ParT Global ParT X->bbbb score",precision=10),
        globalParT_Xbbcc = Var("bDiscriminator('pfParticleTransformerAK8MDJetTags:probHZZbbcc')+bDiscriminator('pfParticleTransformerAK8MDJetTags:probHZxZxbbcc')+bDiscriminator('pfParticleTransformerAK8MDJetTags:probHZxZxStarbbcc')",float,doc="Global ParT Global ParT X->bbcc score",precision=10),
